      ...
      <header className={styles["main-header"]}>
        <nav className={`${styles["main-header__nav"]} ${styles["main-nav"]}`}>
          <div className={`${styles["main-nav__list"]} ${styles["site-nav"]}`}>
            <Link href="#" className={`${styles["site-nav__logo"]} ${styles.logo}`}>
              <Image
            ...
            <ul className={styles["site-nav__list"]}>
              ...
              >
                <IconButton
                  className={styles["site-nav__button"]}
                  variant="transparent"
                  icon="arrow-down"
                  iconSize={16}
                  iconPosition="right"
                ...
                <ul className={styles["header-catalog__list"]}>
                  ...
                  >
                    <Link className={styles["header-catalog__link"]} href="#">
                      Новинки
                    </Link>
                  </li>
              ...
              <li className={styles["site-nav__item"]}>
                <Link className={styles["site-nav__link"]} href="#">
                  Доставка и оплата
                </Link>
              </li>
              <li className={styles["site-nav__item"]}>
          ...
          <div className={`${styles["main-nav__list"]} ${styles["user-nav"]}`}>
            <Link className={styles["user-nav__phone"]} href="tel:+78005558628">
              +7 800 555-86-28
            </Link>
            <ul className={styles["user-nav__list"]}>
              ...
              >
                <IconButton
                  ...
                  iconLabel="Поиск."
                />
                <div className={`${styles.popover} ${styles["popover-search"]}`}>
              ...
              >
                ...
                <div className={`${styles.popover} ${styles["popover-login"]}`}>
                  <div className={styles["popover__content"]}>
                    <h2 className={styles["popover__title"]}>Личный кабинет</h2>
                    <form
                    ...
                    <div className={styles["popover-login__signin-block"]}>
                      <Button type="submit" variant="secondary">
                        Войти
                      </Button>
                      <div className={styles["popover-login__signin-info"]}>
                        <Link className={styles["popover-login__link"]} href="#">
                          Забыли пароль?
                        </Link>
                        <Link className={styles["popover-login__link"]} href="#">
                          Регистрация
                  ...
                  <div className={styles["popover__content"]}>
                    ...
                    <ul className={styles["popover-cart__list"]}>
                      ...
                      >
                        ...
                        <IconButton
                          className={styles["cart-product__cross-button"]}
                          icon="cross"
                          iconSize={16}
                          iconLabel="Удалить из корзины."
                        />
                      </li>
                      <li
                        className={`${styles["popover-cart__item"]} ${styles["cart-product"]}`}
      ...
      <footer className={`${styles["main-footer"]} ${styles.wrapper}`}>
        ...
        <div className={`${styles["main-footer__list"]} ${styles.copyright}`}>
          ...
          <p className={styles["copyright__text"]}>
            Сделано в{" "}
            <Link
              className={styles["copyright__text-link"]}
              href="https://htmlacademy.ru/"
            >
              .html academy
            </Link>{" "}
